...
! function () {
    ...
    function h(e) {
        $ = null;
        var t = !1;
        "SELECT" == e.tagName ? (n("mousedown", e, 0, 0), e.focus && e.focus(), t = !0) : g() === e ? t = !0 : /^(input|textarea)$/i.test(e.tagName) || e.isContentEditable ? (t = !0, e.focus && e.focus(), e.value = e.value, H && ($ = e)) : f(), t && (g(e), ionic.trigger("ionic.focusin", {
            target: e
        }, !0))
    }
    ...
    function v(e) {
        ...
        var t = ionic.tap.pointerCoord(e),
            ...
            i = n && e.target.classList.contains("button") ? B : q;
    ...
    window.ionic = window.ionic || {}, window.ionic.views = {}, window.ionic.version = "1.0.0-rc.1",
        function (e) {
        ...
        function (e, t, n) {
            ...
            n.DomUtil = {
                ...
                getChildIndex: function (e, t) {
                    if (t)
                        for (var n, i = e.parentNode.children, r = 0, o = 0, s = i.length; s > r; r++)
        ...
        function (e) {
            e.CustomEvent = function () {
                ...
                on: function (t, n, i) {
                    for (var r = i || window, o = 0, s = this.VIRTUALIZED_EVENTS.length; s > o; o++)
            ...
            e.Gestures.event = {
                ...
                extendEventData: function (t) {
                    ...
                    var o = t.timeStamp - n.timeStamp,
                        ...
                        l = e.Gestures.utils.getVelocity(o, s, a);
    ...
    ionic.tap = {
            register: function (t) {
                return k = t, e("click", !0, !0), e("mouseup"), e("mousedown"), window.navigator.pointerEnabled ? (e("pointerdown"), e("pointerup"), e("pointcancel"), U = "pointermove") : window.navigator.msPointerEnabled ? (e("MSPointerDown"), e("MSPointerUp"), e("MSPointerCancel"), U = "MSPointerMove") : (e("touchstart"), e("touchend"), e("touchcancel")), e("focusin"), e("focusout"),
                    function () {
    ...
    ionic.keyboard = {
        ...
        landscape: !1,
        hide: function () {
            clearTimeout(J), clearTimeout(j), clearTimeout(Q), ionic.keyboard.isOpen = !1, ionic.trigger("resetScrollView", {
                target: K
    ...
    ! function (e) {
        ...
        e.views.Scroll = e.views.View.inherit({
                ...
                if (n.scrollChildIntoView = function (t) {
                        ...
                        if (!n.isScrolledIntoView) {
                            if (e.Platform.isIOS() || e.Platform.isFullScreen) {
                                ...
                                var o = t.detail.viewportHeight - r,
                                    s = Math.max(0, t.detail.keyboardHeight - o);
                    ...
                    }), "ontouchstart" in window) i.addEventListener("touchstart", n.touchStart, !1), n.options.preventDefault && i.addEventListener("touchmove", n.touchMoveBubble, !1), document.addEventListener("touchmove", n.touchMove, !1), document.addEventListener("touchend", n.touchEnd, !1), document.addEventListener("touchcancel", n.touchEnd, !1);
                else if (window.navigator.pointerEnabled) i.addEventListener("pointerdown", n.touchStart, !1), n.options.preventDefault && i.addEventListener("pointermove", n.touchMoveBubble, !1), document.addEventListener("pointermove", n.touchMove, !1), document.addEventListener("pointerup", n.touchEnd, !1), document.addEventListener("pointercancel", n.touchEnd, !1), document.addEventListener("wheel", n.mouseWheel, !1);
                else if (window.navigator.msPointerEnabled) i.addEventListener("MSPointerDown", n.touchStart, !1), n.options.preventDefault && i.addEventListener("MSPointerMove", n.touchMoveBubble, !1), document.addEventListener("MSPointerMove", n.touchMove, !1), document.addEventListener("MSPointerUp", n.touchEnd, !1), document.addEventListener("MSPointerCancel", n.touchEnd, !1), document.addEventListener("wheel", n.mouseWheel, !1);
                else {
                    var r = !1;
            ...
            zoomTo: function (e, t, n, i) {
                ...
                var s = (n + r.__scrollLeft) * e / o - n,
                    a = (i + r.__scrollTop) * e / o - i;
            ...
            doTouchMove: function (e, t, n) {
                ...
                if (i.__isTracking) {
                    ...
                    if (i.__isDragging) {
                        i.__decStopped = !1;
                        var a = r - i.__lastTouchLeft,
                            l = o - i.__lastTouchTop,
                            c = i.__scrollLeft,
                            u = i.__scrollTop,
                            d = i.__zoomLevel;
                        ...
                        var g = i.options.locking ? 3 : 0,
                            v = 5,
                            T = Math.abs(r - i.__initialTouchLeft),
                            E = Math.abs(o - i.__initialTouchTop);
                ...
                if (i.__isTracking) {
                    if (i.__isTracking = !1, i.__isDragging)
                        if (i.__isDragging = !1, i.__isSingleTouch && i.options.animating && n - i.__lastTouchMove <= 100) {
                            ...
                            if (s !== o) {
                                var l = r[o] - r[s],
                                    c = i.__scrollLeft - r[s - 2],
                                    u = i.__scrollTop - r[s - 1];
        ...
        u.prototype = new l, u.prototype._moveElement = function (t) {
            ...
            if (this._currentDrag) {
                ...
                if (this.scrollView) {
                    ...
                    var a = s.offsetTop,
                        l = a - r + this._currentDrag.elementHeight / 2,
                        c = r + this._currentDrag.elementHeight / 2 - a - s.offsetHeight;
            ...
            initialize: function (t) {
                ...
                }, t), e.extend(n, t), !n.itemHeight && n.listEl && (n.itemHeight = n.listEl.children[0] && parseInt(n.listEl.children[0].style.height, 10)), n.onRefresh = t.onRefresh || function () {}, n.onRefreshOpening = t.onRefreshOpening || function () {}, n.onRefreshHolding = t.onRefreshHolding || function () {}, window.ionic.onGesture("release", function (e) {
                    n._handleEndDrag(e)
            ...
            didScroll: function (e) {
                ...
                if (t.isVirtual) {
                    var n = t.itemHeight,
                        i = (t.listEl.children.length, e.target.scrollHeight),
                        r = t.el.parentNode.offsetHeight,
                        o = (e.scrollTop, Math.max(0, e.scrollTop + t.virtualRemoveThreshold)),
                        s = Math.min(i, Math.abs(e.scrollTop) + r + t.virtualAddThreshold),
                        a = Math.floor((s - o) / n),
                        l = parseInt(Math.abs(o / n), 10),
                        c = parseInt(Math.abs(s / n), 10);
        ...
        e.views.Toggle = e.views.View.inherit({
            ...
            drag: function (t) {
                ...
                this._dragInfo && (t.gesture.srcEvent.preventDefault(), e.requestAnimationFrame(function () {
                    if (n._dragInfo) {
                        var e = (n.track.offsetLeft + n.handle.offsetWidth / 2, n.track.offsetLeft + n.track.offsetWidth - n.handle.offsetWidth / 2, t.gesture.deltaX, t.gesture.touches[0].pageX - n._dragInfo.left),
...
! function () {
    function e(e, t, n, i, o, r) {
        function a(i, a, c, s, l) {
            ...
            var C, T = k[1],
                ...
                L = angular.isDefined(D) ? parseInt(D) : E,
                _ = c.itemHeight || c.collectionItemHeight,
    ...
    function t(e, t, n) {
        ...
        return function (r) {
            ...
            function c(t) {
                if (!c.destroyed) {
                    var n, i, r, a, u = tt.getScrollValue(),
                        d = u + tt.scrollPrimarySize;
                    ...
                    if (b)
                        for (n = 0, ii = K.length; n < ii && (i = K[n]); n++)
                            if (i.images)
                                for (var f, h = 0, p = i.images.length; p > h && (f = i.images[h]); h++) {
                                    var v = f.src;
                                    f.src = x, f.src = v
                                }
                    if (t)
                        for (var g = e.$$phase; K.length;) i = K.pop(), g || i.scope.$digest();
                    else s()
                }
            }
            ...
            function v() {
                ...
                this.updateRenderRange = function (e, t) {
                    var n, i, o;
                    if (this.getDimensions(2 * this.getEstimatedIndex(t)), -1 === l || 0 === e) n = 0;
                    else if (e >= u)
                        for (n = l, i = E.length; i > n && !((o = this.getDimensions(n)) && o.primaryPos + o.primarySize >= e); n++);
                    else
                        for (n = l; n >= 0; n--)
                    ...
                    var r;
                    for (n = W + 1, i = E.length; i > n; n++)
                        if ((o = this.getDimensions(n)) && o.primaryPos + o.primarySize > t) {
                            if (M)
            ...
            var g, m, $ = r.afterItemsNode,
                w = r.containerNode,
                b = r.forceRefreshImages,
                y = r.heightData,
                S = r.widthData,
                k = r.keyExpression,
                C = r.renderBuffer,
                ...
                R = !!B.options.scrollingY,
                M = R ? S.dynamic || S.value !== B.__clientWidth : y.dynamic || y.value !== B.__clientHeight,
                N = !y.dynamic && !S.dynamic,
                H = "PRIMARY",
                z = "SECONDARY",
                O = R ? "translate3d(SECONDARYpx,PRIMARYpx,0)" : "translate3d(PRIMARYpx,SECONDARYpx,0)",
                U = R ? "height: PRIMARYpx; width: SECONDARYpx;" : "height: SECONDARYpx; width: PRIMARYpx;",
                q = 0,
                F = 0,
                W = -1,
                X = -1,
            ...
            var nt = R ? "getContentHeight" : "getContentWidth",
                it = B.options[nt];
            ...
            this.refreshLayout = function () {
                ...
                var e = getComputedStyle($) || {},
                    n = $.firstElementChild && getComputedStyle($.firstElementChild) || {},
                    i = $.lastElementChild && getComputedStyle($.lastElementChild) || {};
                ...
                var r = w.previousElementSibling,
                    c = r ? t.getComputedStyle(r) : {},
                    s = parseInt(c[R ? "marginBottom" : "marginRight"] || 0);
                if (w.style[ionic.CSS.TRANSFORM] = O.replace(H, -s).replace(z, 0), q -= s, B.__clientHeight && B.__clientWidth || (B.__clientWidth = B.__container.clientWidth, B.__clientHeight = B.__container.clientHeight), (tt.onRefreshLayout || angular.noop)(), tt.refreshDirection(), et(), !ot)
                    for (var u = Math.max(20, 3 * C), d = 0; u > d; d++) j.push(new l);
    ...
    var s = {
        ...
        l = angular.module("ionic", ["ngAnimate", "ngSanitize", "ui.router"]),
        u = angular.extend,
        d = angular.forEach,
        f = angular.isDefined,
        h = angular.isNumber,
    ...
    l.factory("$ionicActionSheet", ["$rootScope", "$compile", "$animate", "$timeout", "$ionicTemplateLoader", "$ionicPlatform", "$ionicBody", function (e, t, n, i, o, r, a) {
        function c(o) {
            ...
            var d = s.element = t('<ion-action-sheet ng-class="cssClass" buttons="buttons"></ion-action-sheet>')(s),
                f = v(d[0].querySelector(".action-sheet-wrapper")),
                h = s.cancelOnStateChange ? e.$on("$stateChangeSuccess", function () {
                    s.cancel()
                }) : g;
        ...
        var r = v('<div class="backdrop">'),
            a = 0;
        return e[0].body.appendChild(r[0]), {
            retain: n,
            release: i,
            getElement: o,
            _element: r
        ...
        return L.prototype.initialize = function (e) {
            ...
            register: function (e, t) {
                var i, a, l, u = v(),
                    ...
                    z = m.historyId,
                    O = n.url();
                if ($ !== u && ($ = u, P++), y) M = y.viewId, N = y.action, H = y.direction, y = null;
                else if (_ && _.stateId === u) M = _.viewId, z = _.historyId, N = C, _.historyId === L.historyId ? H = B : L && (H = A, i = d(_.historyId), i && i.parentHistoryId === L.historyId ? H = x : (i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId && (H = E)));
                else if (R && R.stateId === u) M = R.viewId, z = R.historyId, N = T, R.historyId === L.historyId ? H = I : L && (H = A, L.historyId === m.parentHistoryId ? H = x : (i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId && (H = E))), i = h(e), R.historyId && i.scope && (i.scope.$historyId = R.historyId, z = R.historyId);
                else if (L && L.historyId !== z && m.cursor > -1 && m.stack.length > 0 && m.cursor < m.stack.length && m.stack[m.cursor].stateId === u) {
                ...
                if (p(M), D.backView && z == D.backView.historyId && u == D.backView.stateId && O == D.backView.url)
                    for (a = 0; a < m.stack.length; a++)
                        if (m.stack[a].viewId == M) {
    ...
    var m = '<div class="loading-container"><div class="loading"></div></div>',
        ...
        w = "$ionicLoading instance.show() has been deprecated. Use $ionicLoading.show().",
        b = "$ionicLoading instance.setContent() has been deprecated. Use $ionicLoading.show({ template: 'my content' }).";
    l.constant("$ionicLoadingConfig", {
        template: "<ion-spinner></ion-spinner>"
    }).factory("$ionicLoading", ["$ionicLoadingConfig", "$ionicBody", "$ionicTemplateLoader", "$ionicBackdrop", "$timeout", "$q", "$log", "$compile", "$ionicPlatform", "$rootScope", function (e, t, n, i, o, r, a, c, l, d) {
        function f() {
            return v || (v = n.compile({
                template: m,
                appendTo: t.get()
            }).then(function (e) {
        ...
        function h(t) {
            ...
            return S(), k(), t.hideOnStateChange && (S = d.$on("$stateChangeSuccess", p), k = d.$on("$stateChangeError", p)), o.cancel(C), C = o(g, n), C.then(f).then(function (e) {
                ...
                hide: s.method($, a.error, p),
                show: s.method(w, a.error, function () {
                    h(t)
                }),
    ...
    l.provider("$ionicPlatform", function () {
        ...
        function o(e, o) {
            var a = v(e.target || e),
                c = t.offset(a),
                s = o.prop("offsetWidth"),
                l = o.prop("offsetHeight"),
                u = n[0].body.clientWidth,
                d = i.innerHeight,
                f = {
                    left: c.left + c.width / 2 - s / 2
                },
                h = v(o[0].querySelector(".popover-arrow"));
            f.left < r ? f.left = r : f.left + s + r > u && (f.left = u - s - r), c.top + c.height + l > d && c.top - l > 0 ? (f.top = c.top - l, o.addClass("popover-bottom")) : (f.top = c.top + c.height, o.removeClass("popover-bottom")), h.css({
                left: c.left + c.width / 2 - h.prop("offsetWidth") / 2 - f.left + "px"
            }), o.css({
                top: f.top + "px",
                left: f.left + "px",
                marginLeft: "0",
    ...
    l.factory("$ionicPopup", ["$ionicTemplateLoader", "$ionicBackdrop", "$q", "$timeout", "$rootScope", "$ionicBody", "$compile", "$ionicPlatform", function (e, t, n, i, o, r, a, c) {
            ...
            function d(e) {
                ...
                var o = b._createPopup(e),
                    a = w[0];
                a && a.hide();
                var s = i(g, a ? $.stackPushDelay : 0).then(function () {
                    return o
                }).then(function (e) {
                    return a || (r.addClass("popup-open"), t.retain(), b._backButtonActionDone = c.registerBackButtonAction(l, T)), w.unshift(e), e.show(), e.responseDeferred.notify({
                        close: s.close
                    }), e.responseDeferred.promise.then(function (n) {
                        var o = w.indexOf(e); - 1 !== o && w.splice(o, 1), e.remove();
                        var a = w[0];
        ...
        }]), l.service("$ionicScrollDelegate", ionic.DelegateService(["resize", "scrollTop", "scrollBottom", "scrollTo", "scrollBy", "zoomTo", "zoomBy", "getScrollPosition", "anchorScroll", "freezeScroll", "freezeAllScrolls", "getScrollView"])), l.service("$ionicSideMenuDelegate", ionic.DelegateService(["toggleLeft", "toggleRight", "getOpenRatio", "isOpen", "isOpenLeft", "isOpenRight", "canDragContent", "edgeDragThreshold"])), l.service("$ionicSlideBoxDelegate", ionic.DelegateService(["update", "slide", "select", "enableSlide", "previous", "next", "stop", "autoPlay", "start", "currentIndex", "selected", "slidesCount", "count", "loop"])), l.service("$ionicTabsDelegate", ionic.DelegateService(["select", "selectedIndex"])),
        function () {
            var e = [];
            l.factory("$ionicTemplateCache", ["$http", "$templateCache", "$timeout", function (t, n, i) {
                ...
                function r() {
                    if (o._runCount++, a = !0, 0 !== c.length) {
                        for (var e = 0; 4 > e && (template = c.pop());) p(template) && t.get(template, {
                            cache: n
                        }), e++;
                        c.length && i(r, 1e3)
                    }
                ...
                t.state = function (o, r) {
                    if ("object" == typeof r) {
                        ...
                        if (a && p(r.templateUrl) && e.push(r.templateUrl), angular.isObject(r.views))
                            for (var c in r.views) a = r.views[c].prefetchTemplate !== !1 && e.length < n.templates.maxPrefetch(), a && p(r.views[c].templateUrl) && e.push(r.views[c].templateUrl)
                    }
                    return i.call(t, o, r)
                }
            ...
            function c(n) {
                ...
                return r.then(function (i) {
                    var r, a = n.scope || o.$new(),
                        c = v("<div>").html(i).contents();
                    return n.controller && (r = t(n.controller, u(n.locals, {
                        $scope: a
                    })), c.children().data("$ngControllerController", r)), n.appendTo && v(n.appendTo).append(c), e(c)(a), {
                        element: c,
                        scope: a
                    }
                })
                        ...
                        var R, M, N, H = ++A,
                            z = {
                                ...
                                transition: function (a, c, f) {
                                    ...
                                    var q = o.transitions.views[O.transition] || o.transitions.views.none,
                                        F = q(R, M, O.direction, O.shouldAnimate && f && _);
                                    if (F.shouldAnimate && (R.on($, w), R.data(k, e(b, D)), i.show(D)), E && (z.emit("before", O, U), h(R, x), F.run(0)), _ && (C = n.defer(), P.push(C.promise)), E && _) e(p, 16);
                                    else {
            ...
            B.init = function () {
                ...
                var s = n.alignTitle || a.navBar.alignTitle(),
                    u = v("<ion-header-bar>").addClass(n["class"]).attr("align-title", s);
                f(n.noTapScroll) && u.attr("no-tap-scroll", n.noTapScroll);
                var h, p, g = v('<div class="title title-' + s + '">'),
                    m = {},
                    $ = {};
                ...
                var y = u.data("$ionHeaderBarController"),
                    B = {
                        isActive: o,
                        title: function (e) {
                            y.title(e)
                ...
                var n = B.isInitialized ? h() : u(),
                    i = B.isInitialized ? u() : null,
                    o = n.controller();
                ...
                var c = e.controller(),
                    s = a.transitions.navBar[i.navBarTransition] || a.transitions.navBar.none,
                    l = i.transitionId;
                c.beforeEnter(i);
            ...
            var l = s.element = t.el,
                u = s.$element = v(l),
                d = s.scrollView = new ionic.views.Scroll(t);
            ...
            m.$scope = e, m.initialize = function (e) {
                ...
                var t = e / 100;
                if (m.left && e >= 0) m.openAmount(m.left.width * t);
                else if (m.right && 0 > e) {
                    {
                        m.right.width
                    }
                ...
                var t = m.left && m.left.width || 0,
                    n = m.right && m.right.width || 0;
                ...
                var n = m.edgeThresholdEnabled && !m.isOpen(),
                    i = t.gesture.startEvent && t.gesture.startEvent.center && t.gesture.startEvent.center.pageX,
                    o = !n || i <= m.edgeThreshold || i >= m.content.element.offsetWidth - m.edgeThreshold,
                    a = r.backView(),
                    c = $ ? !0 : !a;
                if (!c) {
                    var s = r.currentView() || {};
        ...
        return {
            ...
            compile: function (e, o) {
                function r(e, r, c) {
                    ...
                    else if ("true" !== o.overflowScroll && i.scrolling.jsScrolling()) {
                        var l = {
                            el: r[0],
                ...
                var a;
                return e.addClass("scroll-content ionic-scroll"), "false" != o.scroll ? (a = v('<div class="scroll"></div>'), a.append(e.contents()), e.append(a)) : e.addClass("scroll-content-false"), {
                    pre: r
                }
            }
        }
    ...
    var P = '<a class="item-content" ng-href="{{$href()}}" target="{{$target()}}"></a>',
        D = '<div class="item-content"></div>';
    l.directive("ionItem", ["$$rAF", function (e) {
        return {
            ...
            scope: !0,
            compile: function (t, n) {
                var i = f(n.href) || f(n.ngHref) || f(n.uiSref),
    ...
    l.directive("ionDeleteButton", function () {
        return {
            ...
            compile: function (e, t) {
                return t.$set("class", (t["class"] || "") + " button icon button-icon", !0),
                    function (e, t, n, i) {
                        function o() {
    ...
    l.directive("ionReorderButton", ["$parse", function (e) {
        ...
        return {
            ...
            controller: ["$scope", "$element", "$attrs", function (t, o, r) {
                var a = t.$eval(t.doesContinue) === !0,
                    c = f(r.autoPlay) ? !!t.autoPlay : !1,
                    s = c ? t.$eval(t.slideInterval) || 4e3 : 0,
                    l = new ionic.views.Slider({
                        el: o[0],
                        auto: s,
                        continuous: a,
        ...
        return {
            ...
            require: "^ionSlideBox",
            compile: function (e) {
                return e.addClass("slider-slide"),
                    function () {}
            }
        }
